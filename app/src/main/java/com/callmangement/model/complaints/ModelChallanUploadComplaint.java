...
public class ModelChallanUploadComplaint {
    @SerializedName("status") private String status;
    @SerializedName("message") private String message;
    @SerializedName("Data") private List<ModelComplaintList> Complaint_List = new ArrayList<>();
    ...
    public ModelChallanUploadComplaint(int totalItems, int totalPages, int currentPage) {
