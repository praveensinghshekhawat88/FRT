...
class SendToSECenterListActivityAdapter(private val context: Context) :
    RecyclerView.Adapter<SendToSECenterListActivityAdapter.ViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = DataBindingUtil.inflate<ItemSendToSeCenterListBinding>(
            LayoutInflater.from(parent.context),
            R.layout.item_send_to_se_center_list,
            parent,
            false
        )
    ...
    class ViewHolder(val binding: ItemSendToSeCenterListBinding) : RecyclerView.ViewHolder(
        binding.root
    )
