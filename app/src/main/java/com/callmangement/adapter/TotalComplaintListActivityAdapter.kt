...
public class TotalComplaintListActivityAdapter extends RecyclerView.Adapter<TotalComplaintListActivityAdapter.ViewHolder> implements Filterable {
    private final Context context;
    private int row_index = 0;
    List<ModelComplaintList> modelComplaintList;
    private List<ModelComplaintList> modelComplaintFilterList;

    public TotalComplaintListActivityAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemTotalComplaintListBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.item_total_complaint_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Log.d("textComplaintStatusValue","---"+model.getComplainStatusId());
        ...
        } else if (model.getComplainStatusId().equals("4")){
            holder.binding.textComplaintStatusValue.setText(model.getComplainStatus());
            holder.binding.textComplaintStatusValue.setTextColor(context.getResources().getColor(R.color.colorBrown));
         } else if (model.getComplainStatusId().equals("6")){
            holder.binding.textComplaintStatusValue.setText(model.getComplainStatus()); // Default value
            holder.binding.textComplaintStatusValue.setTextColor(context.getResources().getColor(R.color.blue_700));
        }

        else {
            holder.binding.textComplaintStatusValue.setText(model.getComplainStatus()); // Default value
            holder.binding.textComplaintStatusValue.setTextColor(context.getResources().getColor(R.color.deep_purple_300)); // Default color
        }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        private final ItemTotalComplaintListBinding binding;
        public ViewHolder(@NonNull ItemTotalComplaintListBinding binding) {
