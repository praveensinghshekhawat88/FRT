...
class ComplaintPendingListActivityAdapter(private val context: Context) :
    RecyclerView.Adapter<ComplaintPendingListActivityAdapter.ViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = DataBindingUtil.inflate<ItemComplaintPendingListActivityBinding>(
            LayoutInflater.from(parent.context),
            R.layout.item_complaint_pending_list_activity,
            parent,
            false
        )
    ...
    class ViewHolder(var binding: ItemComplaintPendingListActivityBinding) :
