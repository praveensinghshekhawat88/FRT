...
class TrainingScheduleListForSEActivityAdapter(private val context: Context) :
    RecyclerView.Adapter<TrainingScheduleListForSEActivityAdapter.ViewHolder>() {
    private var list: List<ModelTrainingScheduleList>? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = DataBindingUtil.inflate<ItemTrainingScheduleListForSeActivityBinding>(
            LayoutInflater.from(parent.context),
            R.layout.item_training_schedule_list_for_se_activity,
            parent,
            false
        )
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.crdItem.setOnClickListener { view: View? ->
            context.startActivity(
                Intent(
                    context, TrainingScheduleFormActivity::class.java
                )
            )
        }
    }
    ...
    class ViewHolder(val binding: ItemTrainingScheduleListForSeActivityBinding) :
