...
class SLAReportsDetailsActivityAdapter(private val context: Context) :
    RecyclerView.Adapter<SLAReportsDetailsActivityAdapter.ViewHolder>(),
    Filterable {
    ...
    class ViewHolder(val binding: ItemSlaReportsDetailsActivityBinding) :
    ...
    private val Searched_Filter: Filter = object : Filter() {
        ...
        override fun publishResults(constraint: CharSequence, results: FilterResults) {
            if (results.values != null) {
                ...
                modelComplaintList!!.addAll(results.values as Collection<ModelSLAReportDetailsList>)
                notifyDataSetChanged()
            }
        }
    }
