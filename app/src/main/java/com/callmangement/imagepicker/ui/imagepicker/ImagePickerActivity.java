...
import com.callmangement.imagepicker.listener.OnBackAction;
import com.callmangement.imagepicker.listener.OnFolderClickListener;
import com.callmangement.imagepicker.listener.OnImageClickListener;
import com.callmangement.imagepicker.listener.OnImageSelectionListener;
...
import com.callmangement.imagepicker.widget.ImagePickerToolbar;
import com.callmangement.imagepicker.widget.ProgressWheel;
...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerView {
    ...
    private void getDataWithPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            PermissionHelper.checkPermission(this, Manifest.permission.READ_MEDIA_IMAGES, new PermissionHelper.PermissionAskListener() {
                @Override
