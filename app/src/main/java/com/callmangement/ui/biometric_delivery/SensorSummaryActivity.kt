...
public class SensorSummaryActivity extends CustomActivity {
    private ActivitySensorSummaryBinding binding;
    ...
    ArrayList<SensorSummaryResponse.Data> sensorSummaryList;
    ...
    private void getSensorSummary(String districtId, String fromDate, String toDate, String fpscodee) {
        ...
        if (Constants.isNetworkAvailable(mActivity)) {
            ...
            Call<SensorSummaryResponse> call = apiInterface.getSensorDisbnSummaryCnt(USER_Id, fpscodee, districtId,"0", fromDate, toDate);

            call.enqueue(new Callback<SensorSummaryResponse>() {
                @Override
                public void onResponse(@NonNull Call<SensorSummaryResponse> call, @NonNull Response<SensorSummaryResponse> response) {
                    hideProgress();
                ...
                //                    binding.actionBar.buttonPDF.setVisibility(View.VISIBLE);
                                    ...
                                    SensorSummaryResponse sensorSummaryResponse = response.body();
                                    String message = sensorSummaryResponse.getMessage();

                                    sensorSummaryList = sensorSummaryResponse.getData();
                                    ...
                                    SensorSummaryAdapter sensorSummaryAdapter = new SensorSummaryAdapter(sensorSummaryList);
                ...
                @Override
                public void onFailure(@NonNull Call<SensorSummaryResponse> call, @NonNull Throwable error) {
                    hideProgress();
