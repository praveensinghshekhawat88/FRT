...
class SensorSummaryActivity : CustomActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySensorSummaryBinding.inflate(layoutInflater)
    ...
    private fun init() {
        ...
        binding!!.actionBar.textToolbarTitle.text = resources.getString(R.string.summary)
    ...
    private fun getSensorSummary(
        ...
        if (Constants.isNetworkAvailable(mActivity)) {
            ...
            val call = apiInterface.getSensorDisbnSummaryCnt(
                USER_Id,
                fpscodee,
                districtId,
                "0",
                        ...
                        if (response.code() == 200) {
                            if (response.body() != null) {
                                ...
                                if (response.body()!!.status == "200") {
                                    ...
                                    val sensorSummaryAdapter =
                                        SensorSummaryAdapter(sensorSummaryList!!)
                                    binding!!.rvDelivered.adapter = sensorSummaryAdapter
                                } else {
