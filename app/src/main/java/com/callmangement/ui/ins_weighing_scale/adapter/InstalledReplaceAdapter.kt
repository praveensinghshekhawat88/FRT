...
class InstalledReplaceAdapter(
    private val irisInsDataArrayList: ArrayList<InstalledDatum>,
    private val context: Context
) :
    RecyclerView.Adapter<InstalledReplaceAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val itemInstalledlistlBinding = ItemInstalledReplaceBinding
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.rlItem.setOnClickListener { view: View? ->
            val intent = Intent(
                context,
                WeighingScaleReplaceActivity::class.java
            )
            intent.putExtra("param", model)
            intent.putExtra("FPSCODE", model.fpscode)
    ...
    class ViewHolder(val binding: ItemInstalledReplaceBinding) :
