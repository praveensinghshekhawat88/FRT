...
class WeighingScaleDashboard : CustomActivity() {
    ...
    var cvNewDelivery: CardView? = null
    var cvCompleteDelivery: CardView? = null
    var cvAbout: CardView? = null
    var mActivity: Activity? = null
    var builder: AlertDialog.Builder? = null
    var prefManager: PrefManager? = null
    private var binding: ActivityWeighingScaleDashboardBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWeighingScaleDashboardBinding.inflate(
            layoutInflater
        )
    ...
    private fun init() {
        ...
        binding!!.actionBar.textToolbarTitle.text = resources.getString(R.string.dashboard)
    ...
    private fun setUpData() {
        if (prefManager!!.useR_TYPE_ID == "1" && prefManager!!.useR_TYPE.equals(
            ...
            binding!!.cvReplace.visibility = View.GONE
            ...
            binding!!.cvReplace.visibility = View.VISIBLE
    ...
    private fun setClickListener() {
        binding!!.cvInstalled.setOnClickListener {
            ...
            if (vibrator.hasVibrator()) {
                ...
                val i = Intent(this@WeighingScaleDashboard, InstalledList::class.java)
    ...
    public void onSingleClick(View v) {
        ...
        binding!!.cvReplace.setOnClickListener {
            ...
            if (vibrator.hasVibrator()) {
                ...
                val i = Intent(
                    this@WeighingScaleDashboard,
                    InstalledReplaceListActivity::class.java
                )
                i.putExtra("key_districtId", districtId)
                i.putExtra("key_fromDate", fromDate)
                i.putExtra("key_toDate", toDate)
    ...
    private fun getInstallationCntApi(districtId: String?, fromDate: String, toDate: String) {
        ...
        if (isNetworkAvailable(mActivity!!)) {
            ...
            val call =
                service.appWeightCountApiiris(USER_Id, districtId, "0", "0", fromDate, toDate, "0")
            ...
            call.enqueue(object : Callback<CountRoot?> {
                override fun onResponse(call: Call<CountRoot?>, response: Response<CountRoot?>) {
                    ...
                    if (response.isSuccessful) {
                        if (response.code() == 200) {
                                ...
                                if (response.body()!!.status == "200") {
                                    ...
                                    if (countDatum != null && !countDatum.isEmpty()) {
                                        ...
                                        for (datum in countDatum) {
                                            ...
                                            val total = datum.totalDelivered.toString()
                                            Delivered = datum.installationPending.toString()
                                            val Installed = datum.installed.toString()
                            ...
                            Toast.makeText(this@WeighingScaleDashboard, msg, Toast.LENGTH_SHORT)
                                .show()
                        }
                    } else {
                        val msg = "HTTP Error: " + response.code()
                        Toast.makeText(this@WeighingScaleDashboard, msg, Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: Call<CountRoot?>, error: Throwable) {
                    //  Utils.hideCustomProgressDialogCommonForAll();
                    hideProgress()
    ...
    override fun onBackPressed() {
        val i = Intent(this@WeighingScaleDashboard, MainActivity::class.java)
        startActivity(i)
