...
public class ViewImagesListingAdapterIris extends RecyclerView.Adapter<ViewImagesListingAdapterIris.MyViewHolder> {

    private final Context mContext;
    private final ArrayList<weighingDeliveryImagesDetail> getErrorImagesDatumArrayList;
    private OnItemViewClickListener mOnItemViewClickListener;

    public ViewImagesListingAdapterIris(Context context, ArrayList<weighingDeliveryImagesDetail> getErrorImagesDatumArrayList
    ) {
    ...
    public interface OnItemViewClickListener {
        void onItemClick(weighingDeliveryImagesDetail campDocInfo, int position);
    }
