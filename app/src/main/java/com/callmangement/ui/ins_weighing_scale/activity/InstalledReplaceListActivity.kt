...
class InstalledReplaceListActivity : CustomActivity() {
    private var binding: ActivityInstalledReplaceListBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityInstalledReplaceListBinding.inflate(
            layoutInflater
        )
    ...
    private fun setClickListener() {
        binding!!.actionBar.ivBack.setOnClickListener {
            val i = Intent(mContext, WeighingScaleDashboard::class.java)
            startActivity(i)
        }
                        ...
                        if (response.code() == 200) {
                            if (response.body() != null) {
                                ...
                                if (response.body()!!.status == "200") {
                                    ...
                                    val irisInsDataArrayList = installedRoot.data
                                    Log.d(
                                    ...
                                    val installedReplaceAdapter = InstalledReplaceAdapter(
                                        irisInsDataArrayList,
                                        mContext!!
                                    )
                                    mRecyclerView!!.adapter = installedReplaceAdapter
