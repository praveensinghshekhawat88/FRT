...
import com.callmangement.ui.ins_weighing_scale.adapter.InstalledReplaceAdapter;
...
public class InstalledReplaceListActivity extends CustomActivity {
    private ActivityInstalledReplaceListBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInstalledReplaceListBinding.inflate(getLayoutInflater());
    ...
    private void setClickListener() {
        ...
        binding.actionBar.ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(mContext, WeighingScaleDashboard.class);
                startActivity(i);
            }
        });
                        ...
                        if (response.code() == 200) {
                            if (response.body() != null) {
                                ...
                                if (Objects.requireNonNull(response.body()).getStatus().equals("200")) {
                                    ...
                                    ArrayList<InstalledDatum> irisInsDataArrayList = installedRoot.getData();
                                    Log.d("weighInsDataArrayList", "Size...." + irisInsDataArrayList.size());
                                    mRecyclerView.setLayoutManager(new LinearLayoutManager(mContext));
                                    mRecyclerView.addItemDecoration(new DividerItemDecoration(mContext, DividerItemDecoration.VERTICAL));
                                    mRecyclerView.setVisibility(View.VISIBLE);
                                    InstalledReplaceAdapter installedReplaceAdapter = new InstalledReplaceAdapter(irisInsDataArrayList, mContext);
                                    mRecyclerView.setAdapter(installedReplaceAdapter);
