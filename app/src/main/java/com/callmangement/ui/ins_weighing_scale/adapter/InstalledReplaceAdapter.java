...
import com.callmangement.databinding.ItemInstalledReplaceBinding;
import com.callmangement.ui.ins_weighing_scale.activity.InstalledDetail;
import com.callmangement.ui.ins_weighing_scale.activity.WeighingScaleReplaceActivity;
import com.callmangement.ui.ins_weighing_scale.model.Installed.InstalledDatum;

import java.util.ArrayList;

public class InstalledReplaceAdapter extends RecyclerView.Adapter<InstalledReplaceAdapter.ViewHolder> {
    private final ArrayList<InstalledDatum> irisInsDataArrayList;
    private final Context context;

    public InstalledReplaceAdapter(ArrayList<InstalledDatum> irisInsDataArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ItemInstalledReplaceBinding itemInstalledlistlBinding = ItemInstalledReplaceBinding
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       /* if (status.equals("Yes") & status.length() != 0) {
        ...
        holder.binding.rlItem.setOnClickListener(view -> {
            Intent intent = new Intent(context, WeighingScaleReplaceActivity.class);
            intent.putExtra("param", model);
            intent.putExtra("FPSCODE", model.getFpscode());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private final ItemInstalledReplaceBinding binding;
        public ViewHolder(ItemInstalledReplaceBinding binding) {
