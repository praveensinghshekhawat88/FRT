...
public class InstalledImagesDetail {
    ...
    public InstalledImagesDetail(boolean status, String message, int id, String contentType, String photoType, Object uploadedBy, Object srNo, boolean isActive, String contentSize, Object ticketNo, String fileType, int photoTypeId, int deliveryId, String imageName, String imagePath, Object uploadedOn) {
        this.status = status;
