...
import com.callmangement.databinding.ActivitySendToSecenterListBinding;
...
public class SendToSECenterListActivity extends CustomActivity {
    private final int REQUEST_CODE = 1;
    private final List<ModelTehsilList> tehsilList = new ArrayList<>();
    private final String complainStatusId = "1";
    private final String myFormat = "yyyy-MM-dd";
    ActivitySendToSecenterListBinding binding;
    private SendToSECenterListActivityAdapter adapter;
   ...
   String fpscodee;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.actionBar.textToolbarTitle.setText(getResources().getString(R.string.complaint_on_se_center));
    ...
    private void initView() {
        ...
        adapter = new SendToSECenterListActivityAdapter(SendToSECenterListActivity.this);
        adapter.notifyDataSetChanged();
        binding.rvSendToSeList.setHasFixedSize(true);
        binding.rvSendToSeList.setLayoutManager(new LinearLayoutManager(SendToSECenterListActivity.this, LinearLayoutManager.VERTICAL, false));
        binding.rvSendToSeList.setAdapter(adapter);


        binding.rvSendToSeList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
    ...
    private void setDataIntoAdapter(List<ModelComplaintList> modelComplaintList) {
        if (modelComplaintList != null && modelComplaintList.size() > 0) {
         //   binding.textTotalComplaint.setText("" + modelComplaintList.size());
            ...
            binding.rvSendToSeList.setVisibility(View.VISIBLE);
            binding.textNoComplaint.setVisibility(View.GONE);
            adapter.setData(modelComplaintList);
        } else {
            binding.textTotalComplaint.setText("0");
            binding.rvSendToSeList.setVisibility(View.GONE);
