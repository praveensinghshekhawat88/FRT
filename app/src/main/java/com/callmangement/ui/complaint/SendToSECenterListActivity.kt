...
class SendToSECenterListActivity : CustomActivity() {
    ...
    var binding: ActivitySendToSecenterListBinding? = null
    private var adapter: SendToSECenterListActivityAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding!!.actionBar.textToolbarTitle.text =
            resources.getString(R.string.complaint_on_se_center)
    ...
    private fun initView() {
        ...
        adapter = SendToSECenterListActivityAdapter(this@SendToSECenterListActivity)
        adapter!!.notifyDataSetChanged()
        binding!!.rvSendToSeList.setHasFixedSize(true)
        binding!!.rvSendToSeList.layoutManager = LinearLayoutManager(
            this@SendToSECenterListActivity,
            LinearLayoutManager.VERTICAL,
            false
        )
        binding!!.rvSendToSeList.adapter = adapter


        binding!!.rvSendToSeList.addOnScrollListener(object : RecyclerView.OnScrollListener() {
    ...
    private fun setDataIntoAdapter(modelComplaintList: List<ModelComplaintList>?) {
        if (modelComplaintList != null && modelComplaintList.size > 0) {
            ...
            binding!!.rvSendToSeList.visibility = View.VISIBLE
            binding!!.textNoComplaint.visibility = View.GONE
            adapter!!.setData(modelComplaintList)
        } else {
            binding!!.textTotalComplaint.text = "0"
            binding!!.rvSendToSeList.visibility = View.GONE
