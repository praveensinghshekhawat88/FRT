...
class ComplaintDetailActivity : CustomActivity(), View.OnClickListener {
    ...
    private var binding: ActivityComplaintDetailBinding? = null
    ...
    private fun setUpOnClickListener() {
        ...
        binding!!.chkBoxIsPhysicalDamage.setOnClickListener {
            if (binding!!.chkBoxIsPhysicalDamage.isChecked) {
                binding!!.inputDSOLetterHint.visibility = View.VISIBLE
                binding!!.inputDSOLetter.visibility = View.VISIBLE
            } else {
                binding!!.inputDSOLetterHint.visibility = View.GONE
                binding!!.inputDSOLetter.visibility = View.GONE
            }
        }
    }
    ...
    private fun setUpData() {
        ...
        if (prefManager!!.uSER_TYPE_ID.equals(
            ...
            if (param.equals("pending", ignoreCase = true)) {
                binding!!.chkBoxIsPhysicalDamage.visibility = View.VISIBLE
                binding!!.inputRemark.isClickable = true
                binding!!.inputReplacePart.isEnabled = true
                binding!!.inputCourierDetail.isEnabled = true
                binding!!.inputChallanNumber.isEnabled = true
                binding!!.inputResolvedDate.isEnabled = true
                binding!!.inputImageHint.visibility = View.VISIBLE
                binding!!.inputImage.visibility = View.VISIBLE
                binding!!.inputDSOLetterHint.visibility = View.GONE
                binding!!.inputDSOLetter.visibility = View.GONE
                ...
                if (binding!!.chkBoxIsPhysicalDamage.isChecked) {
                    ...
                    binding!!.inputDSOLetter.visibility = View.VISIBLE
                    //gagan
                    binding!!.chkBoxIsPhysicalDamage.isClickable = false
                } else {
                    binding!!.inputDSOLetterHint.visibility = View.GONE
                    binding!!.inputDSOLetter.visibility = View.GONE

                    //gagan
                    binding!!.chkBoxIsPhysicalDamage.isClickable = true
                }


                if (model!!.complainStatusId != null) {
                    if (model!!.complainStatusId == "5") {
                        binding!!.chkBoxIsPhysicalDamage.isClickable = false
                        binding!!.inputRemark.isEnabled = false
                        binding!!.inputReplacePart.isEnabled = false
                        binding!!.inputCourierDetail.isEnabled = false
                        binding!!.inputChallanNumber.isEnabled = false
                        binding!!.inputResolvedDate.isEnabled = false
                        binding!!.inputImageHint.visibility = View.GONE
                        binding!!.inputImage.visibility = View.GONE
                        binding!!.inputDSOLetterHint.visibility = View.GONE
                        binding!!.inputDSOLetter.visibility = View.GONE
                        binding!!.seImage.visibility = View.VISIBLE
                        binding!!.buttonAcceptComplaint.visibility = View.VISIBLE
                        ...
                        binding!!.buttonResolved.visibility = View.VISIBLE
                        binding!!.buttonSliderSendToSE.visibility = View.VISIBLE
                    }
                } else {
                    binding!!.buttonAcceptComplaint.visibility = View.GONE
                    binding!!.buttonResolved.visibility = View.VISIBLE
                ...
                if (model!!.getIsSentToServiceCentre() == "true") {
                    if (model!!.replacedPartsDetail != null && !model!!.replacedPartsDetail.equals(
                        ...
                        binding!!.layoutReplacePartsByServiceCenter.visibility = View.VISIBLE
                        binding!!.inputReplacePartByServiceCenter.setText(model!!.replacedPartsDetail)
                    } else {
                        binding!!.layoutReplacePartsByServiceCenter.visibility = View.GONE
                    }
                } else {
                    binding!!.layoutReplacePartsByServiceCenter.visibility = View.GONE
                }

                if (model!!.courierServicesDetail != null && !model!!.courierServicesDetail.equals(
                        "null",
                        ignoreCase = true
                    )
                ) {
                ...
                if (model!!.sermarkDateStr != null && !model!!.sermarkDateStr.equals(
                        "null",
                        ignoreCase = true
                    )
                ) {
                ...
                if (model!!.challanNo != null && !model!!.challanNo.equals(
                        "null",
                        ignoreCase = true
                    )
                ) {
            ...
            } else if (param.equals("resolved", ignoreCase = true)) {
                binding!!.chkBoxIsPhysicalDamage.isClickable = false
                binding!!.inputRemark.isEnabled = false
                binding!!.inputReplacePart.isEnabled = false
                binding!!.inputCourierDetail.isEnabled = false
            ...
            } else if (param.equals("service_center", ignoreCase = true)) {
                binding!!.chkBoxIsPhysicalDamage.isClickable = false
                binding!!.inputRemark.isEnabled = false
                binding!!.inputReplacePart.isEnabled = false
                binding!!.inputCourierDetail.isEnabled = false
...
//                finish();
    ...
    private fun selectMultiCheckboxForReplacePart() {
        ...
        if (!dialogReplaceParts!!.isShowing) {
            ...
            val dialogBinding = CustomMultiSelectBinding.inflate(
                layoutInflater
            )
    ...
    private fun getCommaSeparatedName(selectedIds: List<ModelPartsList?>): String {
        ...
        for (i in selectedIds.indices) {
            if (selectedIds[i]!!.isSelectFlag) partName.append(", ")
                .append(selectedIds[i]!!.itemName)
        }
