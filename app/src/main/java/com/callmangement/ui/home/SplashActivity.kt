                            ...
                            if (AppConfig.VERSION_CODE >= model!!.version_Code) {
                                ...
                                if (!mContext!!.isFinishing) {
                                    ...
                                    builder.setMessage(resources.getString(R.string.new_version_is_available))
                                        .setCancelable(false)
                                        .setPositiveButton(resources.getString(R.string.go_to_play_store)) { dialog: DialogInterface, id: Int ->
                                            dialog.cancel()
                                        ...
                                        .setNegativeButton(resources.getString(R.string.cancel)) { dialog: DialogInterface, i: Int ->
                                            dialog.cancel()
                                            finish()
                                        }
