...
class UploadImageActivity : CustomActivity(), View.OnClickListener {

    
    var binding: ActivityDistributorPosReportBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDistributorPosReportBinding.inflate(
            layoutInflater
        )
    ...
    private fun setAdapter(list: List<PosDistributionDetail>) {
        if (list.size > 0) {
            ...
            binding!!.recyclerView.adapter = UploadImageActivityAdapter(mContext!!, list)
    ...
    private fun ExcelformTable() {
        ...
        try {
            ...
            Toast.makeText(this@UploadImageActivity, "Excel Sheet Download ", Toast.LENGTH_SHORT)
                .show()
        }
