...
public class RequestStockActivity extends CustomActivity implements View.OnClickListener {
    private ActivityRequestStockBinding binding;
    private InventoryViewModel inventoryViewModel;
    private PrefManager prefManager;
    private final List<ModelRequestStock> list = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityRequestStockBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        binding.actionBar.ivBack.setVisibility(View.VISIBLE);
        binding.actionBar.ivThreeDot.setVisibility(View.GONE);
        binding.actionBar.layoutLanguage.setVisibility(View.GONE);
        binding.actionBar.textToolbarTitle.setText(getResources().getString(R.string.request_stock));
    ...
    private void dialogConfirmationRequestStockList(List<ModelRequestStock> list) {
        try {
            ...
            rvStockList.setAdapter(new DialogRequestStockListAdapter(mContext, list));
