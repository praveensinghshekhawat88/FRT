...
class LastComplaintFPSListActivity : CustomActivity(), View.OnClickListener {
    ...
    private fun districtList() {
        ...
        viewModel!!.district!!.observe(
            this,
            Observer { modelDistrict: ModelDistrict? ->
                isLoading
                if (modelDistrict!!.status == "200") {
                    ...
                    if (districtList != null && districtList!!.size > 0) {
                        ...
                        val dataAdapter = ArrayAdapter(
                            mContext!!, android.R.layout.simple_spinner_item, districtList!!
                        )
                        ...
                        val dataAdapter1 = ArrayAdapter(
                            mContext!!, android.R.layout.simple_spinner_item, tehsilList!!
                        )
