...
public class IrisInstallationPendingPdfActivity extends PDFCreatorActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createPDF("" + System.currentTimeMillis(), new PDFUtil.PDFUtilListener() {
            ...
            public void pdfGenerationFailure(Exception exception) {
                Toast.makeText(IrisInstallationPendingPdfActivity.this, "PDF NOT Created", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected PDFHeaderView getHeaderView(int pageIndex) {
        ...
        SpannableString word = new SpannableString("Iris Installation Pending List");
    ...
    protected PDFBody getBodyViews() {
        ...
        int[] widthPercent = {15, 25, 20, 15, 15}; // Sum should be equal to 100%
        String[] textInTable = {"FPS Code", "Name", "Mobile No.", "District", "Block"};
        ...
        if (Constants.irisInsPendingArrayList != null && Constants.irisInsPendingArrayList.size() > 0) {
            ...
            IrisInstallationPendingListResp.Datum data = Constants.irisInsPendingArrayList.get(0);

            PDFTextView pdfTextViewFPSCode = new PDFTextView(getApplicationContext(), PDFTextView.PDF_TEXT_SIZE.P);
            pdfTextViewFPSCode.setText(data.getFpscode());
            ...
            pdfTextViewTicketNo.setText(data.getDealerName());
            ...
            pdfTextViewDistDate.setText(data.getDealerMobileNo());
            ...
            pdfTextViewPhotoUpload.setText(data.getDistrictName());
            ...
            pdfTextViewFormUpload.setText(data.getBlockName());
            tableRowView1.addToRow(pdfTextViewFormUpload);

            PDFTableView tableView = new PDFTableView(getApplicationContext(), tableHeader, tableRowView1);

            for (int i = 1; i < Constants.irisInsPendingArrayList.size(); i++) {

                data = Constants.irisInsPendingArrayList.get(i);
...
//        startActivity(intentPdfViewer);
        ...
        PDFUtil.printPdf(IrisInstallationPendingPdfActivity.this, savedPDFFile, printAttributeBuilder.build());
