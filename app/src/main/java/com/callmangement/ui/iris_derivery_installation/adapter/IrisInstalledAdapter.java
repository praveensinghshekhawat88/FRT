...
public class IrisInstalledAdapter extends RecyclerView.Adapter<IrisInstalledAdapter.MyViewHolder> {
    private final ArrayList<IrisDeliveryListResponse.Datum> irisInsDataArrayList;
    Context context;

    public IrisInstalledAdapter(ArrayList<IrisDeliveryListResponse.Datum> irisInsDataArrayList, Context context) {
    ...
    @NonNull
    @Override
    public IrisInstalledAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(IrisInstalledAdapter.MyViewHolder holder, int position) {
        ...
        holder.binding.rlItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, IrisInstalledDetailActivity.class);
