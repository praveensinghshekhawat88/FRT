...
public class IrisReplaceListActivity extends CustomActivity {
    private ActivityIrisReplacedListBinding binding;
    ...
    private IrisReplacedAdapter irisInstalledAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityIrisReplacedListBinding.inflate(getLayoutInflater());
    ...
    private void setUpData() {
        ...
        irisInstalledAdapter = new IrisReplacedAdapter(irisInsDataArrayListBlock, mContext);
    ...
    private void getIrisDeliveryInstallationLForReplacement(String districtId, String fromDate, String toDate, String fpscodee,
                                          String serialno) {
        ...
        if (Constants.isNetworkAvailable(mActivity)) {
            ...
            Call<IrisDeliveryListResponse> call = apiInterface.IrisDeliveryInstallationLForReplacement(USER_Id, fpscodee, districtId,
