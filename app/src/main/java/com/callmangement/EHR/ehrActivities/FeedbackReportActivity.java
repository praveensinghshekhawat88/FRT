...
public class FeedbackReportActivity extends CustomActivity {
    private ActivityFeedbackformReportBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFeedbackformReportBinding.inflate(getLayoutInflater());
    ...
    private void init() {
        ...
        binding.actionBar.textToolbarTitle.setText(getResources().getString(R.string.feedback_form_report));
        setUpData();
        setClickListener();
        //  setClickListener();
    }
    ...
    private void setClickListener() {
        binding.actionBar.ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(FeedbackReportActivity.this, MainActivity.class);
                startActivity(i);
            }
        });
                        ...
                        if (response.code() == 200) {
                            if (response.body() != null) {
                                ...
                                if (Objects.requireNonNull(response.body()).getStatus().equals("200")) {
                                    ...
                                    ArrayList<FeedbackbyDCListDatum> feedbackbyDCListDatumArrayList = installedRoot.getData();
                                    Log.d("weighInsDataArrayList", "Size...." + feedbackbyDCListDatumArrayList.size());
                                    mRecyclerView.setLayoutManager(new LinearLayoutManager(FeedbackReportActivity.this));
                                    mRecyclerView.addItemDecoration(new DividerItemDecoration(FeedbackReportActivity.this, DividerItemDecoration.VERTICAL));
                                    mRecyclerView.setVisibility(View.VISIBLE);
                                    FeedbackReportAdapter feedbackReportAdapter = new FeedbackReportAdapter(feedbackbyDCListDatumArrayList, mContext);
                                    mRecyclerView.setAdapter(feedbackReportAdapter);
