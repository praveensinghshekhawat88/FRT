...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerView {
    ...
    private final OnImageClickListener imageClickListener = new OnImageClickListener() {
        @Override
    ...
    private final OnFolderClickListener folderClickListener = new OnFolderClickListener() {
        @Override
