...
public class FeedbackReportAdapter extends RecyclerView.Adapter<FeedbackReportAdapter.ViewHolder> {
    ...
    public FeedbackReportAdapter(ArrayList<FeedbackbyDCListDatum> feedbackbyDCListDatumArrayList, Context context) {
      ...
      holder.binding.tvFeedbackid.setText(String.valueOf(model.getFeedBackId()));
       ...
       /* if (status.equals("Yes") & status.length() != 0) {
        ...
        holder.binding.rlItem.setOnClickListener(view -> {
           Intent intent = new Intent(context, FeedBackReportDetail.class);
