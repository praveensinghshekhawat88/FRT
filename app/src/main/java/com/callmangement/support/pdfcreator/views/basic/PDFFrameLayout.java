...
public class PDFFrameLayout extends com.callmangement.support.pdfcreator.views.basic.PDFView implements Serializable {
    ...
    @Override
    public PDFFrameLayout addView(@NonNull com.callmangement.support.pdfcreator.views.basic.PDFView viewToAdd) {
